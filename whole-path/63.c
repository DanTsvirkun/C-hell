...
/* Указатели являются переменными, которые содержат в себе адрес другого объекта. 
Распределяя память, меняется адресс массива, соответственно и адресс его элементов, но их индексы остаются фиксированными. 
Следовательно, лучше обращаться конкретно через индексы массива. */